        ...
        <div className="text-center mt-12 md:mt-16 px-4">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            <MagneticButton
              ...
              className="px-6 sm:px-8 py-3 sm:py-4 bg-gold text-black font-bold rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-gold/50 text-sm sm:text-base border-none w-full sm:w-auto"
            >
            ...
            <MagneticButton
              ...
              className="px-6 sm:px-8 py-3 sm:py-4 bg-transparent border-2 border-gold text-gold font-bold rounded-lg transition-all duration-300 hover:scale-105 hover:bg-gold hover:text-black shadow-lg text-sm sm:text-base w-full sm:w-auto"
            >
              View Portfolio
            </MagneticButton>
          </div>
