...
export default function ServicesSection() {
  ...
  return (
    <section
      ref={sectionRef}
      id="services"
      className={`min-h-screen bg-gradient-to-b from-white via-gray-50 to-white text-gray-900 relative overflow-hidden ${getSectionSpacingClasses()}`}
    >
      {/* Geometric Pattern */}
      ...
      <div className={`container mx-auto relative z-10 ${getContainerPaddingClasses()}`}>
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <p
            className={`text-lg sm:text-xl text-gray-600 max-w-3xl mx-auto px-4 transition-all duration-1000 delay-200 ${isVisible
              ? 'opacity-100 translate-y-0'
              : 'opacity-0 translate-y-10'
              }`}
          >
